...
class iLIDSVID_i2v(object):
    ...
    def _process_train_data(self, dirnames, cam1=True, cam2=True, sampling_step=4):
        tracklets = []
        num_imgs_per_tracklet = []
    ...
    def _process_test_data(self, dirnames, cam1=True, cam2=True):
        tracklets = []
        num_imgs_per_tracklet = []
        dirname2pid = {dirname:i for i, dirname in enumerate(dirnames)}
...
__factory = {
    'mars': Mars,
    'ilidsvidi2v': iLIDSVID_i2v,
    'dukevid': DukeMTMCVidReID,
}
